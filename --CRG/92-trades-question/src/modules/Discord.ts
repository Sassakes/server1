...
export const listen = (): void => {
            ...
            case 0:
                if (
                    ...
                    const modifiedContent = content
                        ...
                        .replace(/<@&1087902911260004443>/g, "<@&1175009134005997588>")
                        .replace(/<@&1087902715708977262>/g, "<@&1175009368790552668>")
                        .replace(/<@&1144246077432803388>/g, "<@&1175009967904923648>")
                        .replace(/<@&1115215183976071188>/g, "<@&1175010181374017607>")
                        .replace(/<@&1125783842209415258>/g, "<@&1175010486983602176>")
                        .replace(/<@&1144728635970965534>/g, "<@&1175011190842331148>")  //                        .replace(//g, "")
    ...
    function writeToLog(status: string): void {
        const logFilePath = path.join("/var/www/wealthbuilders.group/", "tradequestion.log");
